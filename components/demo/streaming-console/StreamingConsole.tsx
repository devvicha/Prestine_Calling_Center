...
export default function StreamingConsole() {
  ...
  useEffect(() => {
    ...
    const handleContent = (serverContent: LiveServerContent) => {
      ...
      const turns = useLogStore.getState().turns;
      // fix: Property 'at' does not exist on type 'ConversationTurn[]'. Do you need to change your target library? Try changing the 'lib' compiler option to 'es2022' or later.
      const last = turns[turns.length - 1];
